# tap — 90-second demo script

The whole pitch is *"it doesn't feel like crypto."* Show, don't explain. Keep
the phone frame on screen the entire time. Two devices (or two browser
profiles) — **Sender** and **Recipient** — sell the P2P story best.

## Setup (before recording)
- Sender account funded with ~$5–10 USDC (on any chain — ideally **not**
  Arbitrum, so the cross-chain point is real).
- Both signed out to start, so onboarding shows.
- Phone-sized viewport; PWA installed to home screen for the opening shot.
...
**0:00 – 0:10 · The hook**
> "This is tap. Watch me send my friend money — and notice what you *don't* see."

Open tap from the home-screen icon (no browser chrome). Land on Home: **one
balance**, "5 chains underneath."

**0:10 – 0:30 · Send a link**
- Tap **Send** → key in **$5** → note "coffee ☕" → **Create link**.
- "It's securing real money into the link right now — pulling from whatever
  chain I hold, settling on Arbitrum." Show the funding progress, then the
  **QR + link** with the on-chain receipt link.
- Share it to the second device.

**0:30 – 0:55 · Claim it (the magic moment)**
- On the Recipient device, open the link. **"Alex sent you $5.00."**
...
- Recipient is now on Home with their **own one balance**. "They just received
  money cross-chain. They never picked a chain, paid gas, or installed a wallet.
  Their Google account *is* their wallet — EIP-7702, upgraded in place."
